...
This code was tested on Python 3 with Tensorflow `2.2`. There is an older branch that 
contain the code implementation for Tensorflow `1.15`.

**For pytorch users:** If you are interested in a pytorch implementation, take a look in the repository: (https://github.com/vikassharma2k21/Atrial-Fibrillation). 
